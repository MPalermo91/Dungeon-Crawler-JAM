...
#pragma warning restore 0649
        public void Start()
        {
            ...
            //<i>uGUI</i> <size=40>text</size> <size=20>tag</size> and <color=#ff0000ff>color</color> tag <color=#00ff00ff>like this</color>.
            dialogueLines.Enqueue("Hola!, mi nombre es... <delay=0.5>Portos</delay>.");
