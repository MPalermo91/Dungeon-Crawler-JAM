namespace RedBlueGames.Tools.TextTyper
{
    ...
    /// </summary>
    public class DialogoNPC5 : MonoBehaviour
    {
...
#pragma warning restore 0649
        public void Start()
        {
            ...
            dialogueLines.Enqueue("Hola!, mi nombre es <b>PORTOS*</b>.");
            dialogueLines.Enqueue("Soy el Guardia Imperial del Rey <b>Folstag*</b>");
            dialogueLines.Enqueue("Necesito un chequeo médico, debido a que últimamente no me siento al máximo poder.");
            dialogueLines.Enqueue("Estoy perdiendo mi fuerza física y también mi maná");
            dialogueLines.Enqueue("Quizá puede ser envejecimiento o heridas de antiguas batallas");
            dialogueLines.Enqueue("¿Podría ayudarme Doctor?");
            ...
            dialogueLinesRes1.Enqueue("Soy un Reptil Squamata luchador.");
            
            dialogueLinesRes2.Enqueue("Depende que pueda llamarse común, asisto a varios banquetes y siempre tenemos de la mas variada comida de todo el reino.");

            dialogueLinesRes3.Enqueue("Tengo tres, la primera es en la pierna que fue hace ya varios años y fue atendida por los curanderos reales");
            dialogueLinesRes3.Enqueue("otra en el Hombro derecho que siempre me molesta muscularmente y la última en el brazo izquierdo que aún no sana. ");

            dialogueLinesRes4.Enqueue("Hace dos semanas en la batalla de Rik-vika-pontweed mi última herida fue en el brazo izquierdo");
            dialogueLinesRes4.Enqueue("aún no sana, sigo vendándola. Ya está complicándome empuñar mi escudo.");

            dialogueLinesRes5.Enqueue("Podría decir que si, pero los curanderos reales me han dado analgésicos.");

            dialogueLinesRes6.Enqueue("<i>Revisas las heridas y ves lo siguiente:</i>");
            dialogueLinesRes6.Enqueue("<i>1° Herida Pierna derecha con forma de tajo, fue cocido a mano no de muy buena manera, pero en buen estado.</i>");
            dialogueLinesRes6.Enqueue("<i>2° Herida Hombro derecho forma de erupción. Mas que una herida, a simple vista parece un quiste.</i>");
            dialogueLinesRes6.Enqueue("<i>Podría programar una cirugía por eso. Al tacto no pareciera afectarle demasiado en la actividad diaria.</i>");
            dialogueLinesRes6.Enqueue("<i>3° Herida Brazo izquierdo <anim=lightpos>alarmante</anim>, no está curada y sangra, sin duda tiene Hemorragias, los curanderos no parecieran entender como proceder.</i>");

            dialogueLinesRes1Cansado.Enqueue("Soy un Reptil Squamata luchador.");
            dialogueLinesRes2Cansado.Enqueue("Si Doctor, como todos los dias");
            dialogueLinesRes3Cansado.Enqueue("Tengo tres Heridas, puede revisarlas");
            dialogueLinesRes4Cansado.Enqueue("Hace dos semanas y no se me terminó de curar");
            dialogueLinesRes5Cansado.Enqueue("Si aun me duele, pero he tomado analgesicos");
            
            dialogueLinesRes6Cansado.Enqueue("<i>Revisas las heridas y ves lo siguiente:</i>");
            dialogueLinesRes6Cansado.Enqueue("<i>1° Herida Pierna derecha con forma de tajo, fue cocido a mano no de muy buena manera, pero en buen estado.</i>");
            dialogueLinesRes6Cansado.Enqueue("<i>2° Herida Hombro derecho forma de erupción. Mas que una herida, a simple vista parece un quiste.</i>");
            dialogueLinesRes6Cansado.Enqueue("<i>Podría programar una cirugía por eso. Al tacto no pareciera afectarle demasiado en la actividad diaria.</i>");
            dialogueLinesRes6Cansado.Enqueue("<i>3° Herida Brazo izquierdo <anim=fullshake>alarmante</anim>, no está curada y sangra, sin duda tiene Hemorragias, los curanderos no parecieran entender como proceder.</i>");
