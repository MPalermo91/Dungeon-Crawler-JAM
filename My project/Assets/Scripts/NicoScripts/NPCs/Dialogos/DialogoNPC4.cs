namespace RedBlueGames.Tools.TextTyper
{
    ...
    /// </summary>
    public class DialogoNPC4 : MonoBehaviour
    {
...
#pragma warning restore 0649
        public void Start()
        {
            ...
            dialogueLines.Enqueue("Buenas tardes, Soy <i>Fredel</i>.<delay=0.2> </delay> Soy exploradora al servicio del campamento cercano al Rio");
            dialogueLines.Enqueue("Concurro a usted este día, debido a que entre ayer y hoy estuve con mucha irritabilidad en la piel y comezón.");
            dialogueLines.Enqueue("Prácticamente durante todo el día.");
            dialogueLines.Enqueue("Me han revisado y estoy libre de Pulgas de diez patas,<delay=0.1> </delay>no se realmente que podría ser");
            dialogueLines.Enqueue("Por favor, <delay=0.1> </delay>¿Podría usted Ayudarme?");
            ...
            dialogueLinesRes1.Enqueue("Explorador Águila");
            
            dialogueLinesRes2.Enqueue("Tengo una dieta bastante estricta, basada únicamente en comidas de la naturaleza. No he cambiado mi régimen.");

            dialogueLinesRes3.Enqueue("Si, la verdad en el cuerpo en general y bastante urticaria");
            dialogueLinesRes3.Enqueue("De hecho, de la inflamación, he perdido algunas de mis plumas.");

            dialogueLinesRes4.Enqueue("Si, He perdido Plumas y está dificultando mi ascenso por los cielos.");

            dialogueLinesRes5.Enqueue("No he sentido mareos o tener fiebre o algo similar.");

            dialogueLinesRes6.Enqueue("En la cueva de Tamerhill*, según nos informaron");
            dialogueLinesRes6.Enqueue("Se había descubierto un nuevo pasadizo que podía llegar del otro lado del rio, atravesándolo como lo haría un túnel.");
            dialogueLinesRes6.Enqueue("Ahí es donde empecé a sentirme mal y decidí venir aquí.");

            dialogueLinesRes1Cansado.Enqueue("Explorador Águila");
            dialogueLinesRes2Cansado.Enqueue("Tengo una dieta bastante estricta");
            dialogueLinesRes3Cansado.Enqueue("En el cuerpo en General");
            dialogueLinesRes4Cansado.Enqueue("He perdido una cantidad significativa de Plumas");
            dialogueLinesRes5Cansado.Enqueue("No");
            dialogueLinesRes6Cansado.Enqueue("En la última expedición comencé a sentirme mal y vine con usted");
